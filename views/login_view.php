...
<body class="bg-gradient-to-br from-amber-50 to-amber-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-md p-8 flex flex-col items-center">
        <img src="<?php echo BASE_URL; ?>views/images/logo.png" alt="Satori Spa Logo" class="w-16 h-16 mb-4 rounded-full object-contain">
        ...
        <form method="POST" action="<?php echo BASE_URL; ?>login/auth" class="w-full">
            ...
            <button type="submit" class="w-full bg-amber-800 text-white py-3 rounded-lg font-semibold hover:bg-amber-900 transition-colors duration-200">
                Iniciar Sesión
            </button>
        </form>
